SRC = has_ws.c heredoc.c init.c input.c lex.c main.c parse.c redir.c redir_new.c shell.c subs_var.c uninit.c update_pwd.c ws_segs.c
#SRC_AC = path.c
...
SRC_IN += wd_left.c wd_right.c goto.c up.c down.c cancel.c
