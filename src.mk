...
#SRC_IN = bkslash.c bksp.c c_c.c down.c down_ln.c end.c enter.c eoi.c eot.c home.c left.c left_wd.c null.c print.c reset.c right.c right_wd.c strlen.c tab.c up.c up_ln.c vesc.c
